  ...
  experience: [
    {
      ...
      period: '2024 – Present',
      tag: 'Freelance',
      badges: ['Full-Stack', 'Client Work'],
      bullets: [
        'Design and develop full-stack web applications end to end — from architecture to deployment.',
        'Build modern frontends with React and Next.js: responsive UI, smooth interactions, and strong UX.',
        'Implement backend systems with Node.js and Express — REST APIs, authentication (JWT/OTP), and database design (PostgreSQL, MongoDB).',
        'Deliver portfolio websites, business landing pages, and custom web apps tailored to client goals.',
        'Maintain clean architecture and scalable codebases that are easy to extend and hand off.',
        'Manage full project lifecycle: requirements, design, development, testing, and delivery.',
      ],
    },
    {
      ...
      badges: ['React', 'Team'],
      bullets: [
        'Built applications using feature-based architecture to improve scalability and code organisation.',
        'Implemented server state management with TanStack Query — caching and background updates.',
        'Handled routing and URL state synchronisation using TanStack Router.',
        ...
        'Collaborated via Git & GitHub: pull requests, branch workflows, and code reviews.',
      ],
    },
    {
      ...
      bullets: [
        ...
        'Integrated APIs into modular React components and optimised UI performance.',
